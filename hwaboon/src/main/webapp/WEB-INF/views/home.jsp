...
<body class="animsition">
   ...
   <header>
      ...
      <div class="container-menu-desktop">
         ...
         <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
               ...
               <!-- Logo desktop -->      
               <a href="#" class="logo">
                  <img src="resources/images/icons/logo-01.png" alt="Hwaboon">
               </a>
               ...
               <div class="menu-desktop">
                  <ul class="main-menu">
                     ...
                     <li>
                        <a href = "<c:url value ='/item/itemlist'/>"> 전체 상품목록 </a>
                     </li>
      ...
      <div class="wrap-header-mobile">
         ...
         <div class="logo-mobile">
            <a href="index.html"><img src="resources/resources/images/icons/logo-01.png" alt="IMG-LOGO"></a>
         </div>
      ...
      <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
         <div class="container-search-header">
            <button class="flex-c-m btn-hide-modal-search trans-04 js-hide-modal-search">
               <img src="resources/resources/images/icons/icon-close2.png" alt="CLOSE">
            </button>
            ...
            <ul class="header-cart-wrapitem w-full">
               <li class="header-cart-item flex-w flex-t m-b-12">
                  <div class="header-cart-item-img">
                     <img src="resources/resources/images/item-cart-01.jpg" alt="IMG">
                  </div>
               ...
               <li class="header-cart-item flex-w flex-t m-b-12">
                  <div class="header-cart-item-img">
                     <img src="resources/resources/images/item-cart-02.jpg" alt="IMG">
                  </div>
               ...
               <li class="header-cart-item flex-w flex-t m-b-12">
                  <div class="header-cart-item-img">
                     <img src="resources/resources/images/item-cart-03.jpg" alt="IMG">
                  </div>
   ...
   <section class="section-slide">
      <div class="wrap-slick1">
         <div class="slick1">
            <div class="item-slick1" style="background-image: url(resources/resources/images/slide-01.jpg);">
            ...
            <div class="item-slick1" style="background-image: url(resources/resources/images/slide-02.jpg);">
               <div class="container h-full">
                  <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
            ...
            <div class="item-slick1" style="background-image: url(resources/resources/images/slide-03.jpg);">
               <div class="container h-full">
                  <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
